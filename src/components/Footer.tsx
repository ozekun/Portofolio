...
export default function Footer() {
  ...
  const socialLinks = [
    ...
    { icon: Linkedin, href: 'https://www.linkedin.com/in/theo-samangun', label: 'LinkedIn' },
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex flex-col items-center md:items-start space-y-2">
            ...
            <p className="text-xs text-foreground/50">
              Membangun pengalaman digital performa tinggi.
            </p>
          </div>

          {/* Copyright text */}
          <div className="text-xs text-foreground/60 text-center md:text-left order-last md:order-none">
            &copy; {currentYear} Theodorus Fidelis Samangun. Hak Cipta Dilindungi.
          </div>
